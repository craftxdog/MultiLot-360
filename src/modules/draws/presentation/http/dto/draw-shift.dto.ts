...
export class AutoGenerateDrawShiftsDto {
  @ApiPropertyOptional({
    example: '2026-07-07',
    description:
      'Date to ensure. Defaults to today in the API runtime when omitted.',
  })
  @IsOptional()
  @Transform(({ value }) => trimString(value))
  @IsString()
...
export class AutoGenerateDrawShiftsResponseDto {
  ...
  @ApiProperty({ type: () => [DrawShiftResponseDto] })
  shifts: DrawShiftResponseDto[];
}
