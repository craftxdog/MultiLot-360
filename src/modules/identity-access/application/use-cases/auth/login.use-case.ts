...
@Injectable()
export class LoginUseCase extends UseCase<LoginCommand, AuthSession, AppError> {
  constructor(
  ...
  async execute(input: LoginCommand): Promise<Result<AuthSession, AppError>> {
    try {
      ...
      return ErrorFactory.useCase('Invalid email or password', error, 401);
    }
  }
}
