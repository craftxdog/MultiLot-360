...
export class ConfirmPasswordResetLinkDto {
  @ApiProperty({
    description:
      'Opaque one-time recovery token hash generated by Supabase. It must never be logged or placed in a query string.',
  })
  @IsString()
  @MinLength(32)
  @MaxLength(1024)
  @Matches(/^[A-Za-z0-9._~+/=-]+$/, {
    message: 'tokenHash contains invalid characters',
  })
  tokenHash: string;
